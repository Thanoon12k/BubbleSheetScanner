...
def find_student_number(bubbleSheetScanner, warpedFrame, adaptiveFrame):
    ...
    Each student has a 4-digit number (0000-9999). The sheet contains 10 rows (0-9) and 4 columns. 
    ...
    sorted_slices = [sorted(slice, key=bubbleSheetScanner.y_cord_contour, reverse=False) for slice in sliced_contours]
